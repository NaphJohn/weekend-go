...
| 🍜 美食 · 按菜系 | `food.html` | `data/eats.js`（**142 家上榜餐厅**，14 个菜系 + 二级细分（东南亚菜→泰国菜），带大众点评公开评分 / 人均 / 榜单招牌菜 / 连续上榜年数；页面顶部有 **🏆「最值得去」** 推荐框；+ `EATS_META.honors` 米其林 & 黑珍珠名单、`scoreHow` 评分怎么读） |
...
/ **`topHow`（🏆 最值得去 的排序规则）** / `howTo` / **`cuisineGuide`（14 个菜系：去哪片 / 怎么点 / 注意什么）**
